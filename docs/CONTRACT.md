...
- Expected artifacts inside `out/<CARD>/`:
  ...
  - `implementation/implementation_planning_agent_prompt.md` — implementation planning prompt file generated by `implement`
  - `implementation/implementation_executor_agent_prompt.md` — implementation executor prompt file generated by `implement`
