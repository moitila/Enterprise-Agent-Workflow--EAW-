...
- Para cada card da track de origem (paths em 10_inventory.md):
  - {{EAW_WORKDIR}}/out/[card da track de origem]/prompts/
  - {{EAW_WORKDIR}}/out/[card da track de origem]/provenance/prompts_used.yaml
  - {{EAW_WORKDIR}}/out/[card da track de origem]/investigations/
  - {{EAW_WORKDIR}}/out/[card da track de origem]/execution_journal.jsonl
  - {{EAW_WORKDIR}}/out/[card da track de origem]/state_card_*.yaml
  - {{EAW_WORKDIR}}/ci_feedback/[track de origem]/[fase]/
...
- Emitir handoff ao final:
  printf '{"from_phase":"case_reconstruction","status":"completed","messages":[],"codes":[]}' > {{CARD_DIR}}/investigations/20_handoff.json
