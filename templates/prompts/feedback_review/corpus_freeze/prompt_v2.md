...
- Reconciliar por identidade: INCLUDED_FEEDBACK_IDS e MISSING_FEEDBACK_EXECUTION_IDS.
...
- {{EAW_WORKDIR}}/ci_feedback/[track de origem]/ (discovery de feedbacks existentes)
- {{EAW_WORKDIR}}/out/[card da track de origem]/state_card_*.yaml e execution_journal.jsonl de cada card
...
Intervalo de cards: [critério de intervalo]
...
- Emitir handoff ao final:
  printf '{"from_phase":"corpus_freeze","status":"completed","messages":[],"codes":[]}' > {{CARD_DIR}}/investigations/20_handoff.json
