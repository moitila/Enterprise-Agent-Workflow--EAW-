...
- {{EAW_WORKDIR}}/ci_feedback/[track de origem]/[fase]/[arquivo] (conteudo completo)
- {{EAW_WORKDIR}}/out/[card da track de origem]/prompts/ (prompts materializados referenciados nos casos)
...
| evidencia | [citação direta ou path do artefato] |
...
- Emitir handoff ao final:
  printf '{"from_phase":"findings","status":"completed","messages":[],"codes":[]}' > {{CARD_DIR}}/investigations/20_handoff.json
...
- Falhar se {{CARD_DIR}}/analysis/30_findings.md estiver ausente ao final.
- Falhar se {{CARD_DIR}}/analysis/35_feedback_matrix.md estiver ausente ao final.
- Falhar se {{CARD_DIR}}/analysis/36_prompt_quality.md estiver ausente ao final.
- Falhar se {{CARD_DIR}}/analysis/37_feedback_prompt_eval.md estiver ausente ao final.
