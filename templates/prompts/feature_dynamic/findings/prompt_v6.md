...
- Falhar em qualquer tentativa de escrita fora da whitelist (`{{CARD_DIR}}/investigations/20_findings.md`, `{{CARD_DIR}}/investigations/20_handoff.json` e `{{CARD_DIR}}/investigations/_warnings.md`).
