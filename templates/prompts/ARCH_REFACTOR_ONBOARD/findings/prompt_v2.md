...
- Use onboarding ONLY to validate behavior against known patterns
- Do NOT derive implementation decisions
- Do NOT enforce execution contract
...
- Do NOT define plans
- Do NOT enforce pattern changes
- Do NOT interpret onboarding as mandatory action
...
- Ler `{{CARD_DIR}}`
- Ler `{{CARD_DIR}}/context/onboarding/` apenas para validacao contextual, apos resolver exatamente um `resolved_repo_key`
