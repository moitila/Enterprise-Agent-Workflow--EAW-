...
# ONBOARDING CONTEXT (MANDATORY - LIMITED USE)
...
1. Read section `## Repositório principal de onboarding` from `{{CARD_DIR}}/ingest/raw_card_explication.md`.
   If that file is absent or the section is missing, fall back to `{{CARD_DIR}}/intake/00_intake.md`.
...
- Onboarding MUST be used only to improve understanding of terminology and context
- Onboarding MUST NOT be used to infer behavior not present in evidences
- Onboarding MUST NOT trigger code investigation
- Onboarding MUST NOT override evidence-based reasoning
- If onboarding contradicts evidence, ALWAYS trust evidence
...
- Nao misturar onboarding com inferencia tecnica.
