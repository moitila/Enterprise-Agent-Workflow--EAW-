...
- Executar:
  ...
  - exatamente os comandos listados em `## Validacao Read-only` de `10_change_plan.md`
  - A secao `## Validacao Pos-PR` e informativa — nao executar e nao bloquear fase por ela.
